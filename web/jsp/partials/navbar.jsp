    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="${selected == 'application' ? 'active' : '' }" href="/application"><i class="fa fa-align-justify fa-fw"></i> Job Vacancies</a>
                </li>
                <li>
                    <a class="${selected == 'applications' ? 'active' : '' }" href="/applications"><i class="fa fa-align-justify fa-fw"></i> Applications</a>
                </li>
            </ul>
        </div>
    </div>
